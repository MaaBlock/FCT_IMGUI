...
namespace FCT
{
    ...
    void GLFW_VK_ImguiContext::newFrame_updataSize()
    {
        ...
        if (width > 0 && height > 0)
            io.DisplayFramebufferScale = ImVec2((float)display_width / (float)width,
                                                (float)display_height / (float)height);
    }

    void GLFW_VK_ImguiContext::newFrame_UpdateMouseData()
    {
    ...
    void GLFW_VK_ImguiContext::newFrame_updataTime()
    {
        ImGuiIO& io = ImGui::GetIO();
        ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
    ...
    void GLFW_VK_ImguiContext::newFrame_UpdateMonitors()
    {
        ImGuiPlatformIO& platform_io = ImGui::GetPlatformIO();
    ...
    void GLFW_VK_ImguiContext::newFrame_updateMouseCursor()
    {
        ImGuiIO& io = ImGui::GetIO();
        ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
    ...
    void GLFW_VK_ImguiContext::newFrame_UpdateGamepads()
    {
        ImGuiIO& io = ImGui::GetIO();
...
#undef MAP_ANALOG
    ...
    void GLFW_VK_ImguiContext::newFrame_updateInput()
    {
        ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
